...
export default function TypeWriter({ appendClass, hats, prefix }) {
    ...
    let className = "bg-[url('/images/background.jpg')] bg-opacity-10 flex flex-col gap-4 items-center  h-100 justify-center";
    ...
    return (
        <div className={className}  >
            <div className="text-5xl md:text-6xl text-center mx-auto">
                 <span className="text-blue-300 font-bold">Veshnath Acharya</span>
            </div>
            <div className="flex text-blue-500 gap-2 text-2xl md:text-4xl mx-auto">
